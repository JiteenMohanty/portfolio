...
export function About() {
  return (
    <section id="about" className="section relative overflow-hidden">
      <SectionBackdrop tint="pop" corner="tr" />
      <div className="container-px grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div>
          <SectionHeading
        ...
        <Reveal delay={0.15} className="hidden justify-self-center lg:flex">
          <SpiderPanel
            src="/images/spidey/coding.png"
            alt="Spider-Man hunched over a CRT monitor, deep in focus"
            caption="Origin story: unlocked."
            accent="pop"
            rotate={2}
            size="lg"
          />
